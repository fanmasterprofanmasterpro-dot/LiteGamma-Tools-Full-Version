...
class UpdateManager:
    ...
    def update_version_in_file(self, content, new_version):
        ...
        patterns = [
            ...
            (r'CURRENT_VERSION\s*=\s*["\']([^"\']+)["\']', f'CURRENT_VERSION = "1.5.2"'),

            (r'CURRENT_VERSION\s*=\s*([0-9.]+)', f'CURRENT_VERSION = "1.5.2"'),

            (r'__version__\s*=\s*["\']([^"\']+)["\']', f'__version__ = "1.5.2"'),

            (r'VERSION\s*=\s*["\']([^"\']+)["\']', f'VERSION = "1.5.2"')
